...
const THEMES: Record<ThemeId, ThemeColors> = {
  ...
  light: {
    ...
    btnGlassHoverBg: 'rgba(0, 0, 0, 0.06)',
    btnGlassBorder: 'rgba(0, 0, 0, 0.08)',
    btnGlassColor: '#1D1D1F',
    success: '#34C759',
    danger: '#FF3B30',
    selectArrowColor: 'rgba(0,0,0,0.25)',
    ...
    slotBg: '#FFFFFF',
    slotBorder: 'rgba(0, 0, 0, 0.06)',
    slotActiveBg: 'rgba(0, 122, 255, 0.20)',
    slotActiveBorder: 'rgba(0, 122, 255, 0.15)',
    electronBg: '#FFFFFF',
  },
  glass: {
